...
## Native WS connection address[​](#native-ws-connection-address "Direct link to Native WS connection address")

* wss://contract.mexc.com/edge

## Detailed data interaction commands[​](#detailed-data-interaction-commands "Direct link to Detailed data interaction commands")
...
## Filter Subscription[​](#filter-subscription "Direct link to Filter Subscription")
...
### K-line[​](#k-line "Direct link to K-line")
...
### Risk limitation[​](#risk-limitation "Direct link to Risk limitation")
...
### Adl automatic reduction of position level[​](#adl-automatic-reduction-of-position-level "Direct link to Adl automatic reduction of position level")
...
### Position Mode[​](#position-mode "Direct link to Position Mode")
...
## How is depth information maintained[​](#how-is-depth-information-maintained "Direct link to How is depth information maintained")
...
* [Private Channels](#private-channels)
  ...
  + [Asset](#asset)
  + [Position](#position)
  + [Risk limitation](#risk-limitation)
  + [Adl automatic reduction of position level](#adl-automatic-reduction-of-position-level)

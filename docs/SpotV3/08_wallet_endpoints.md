...
| status | deposit status,1:SMALL,2:TIME\_DELAY,3:LARGE\_DELAY, 4:PENDING,5:SUCCESS,6:AUDITING,7:REJECTED 8:REFUND,9:PRE\_SUCCESS,10:INVALID, 11:RESTRICTED,12:COMPLETED |
...
| status | withdraw status,1:APPLY,2:AUDITING,3:WAIT,4:PROCESSING,5:WAIT\_PACKAGING, 6:WAIT\_CONFIRM,7:SUCCESS,8:FAILED,9:CANCEL,10:MANUAL |
